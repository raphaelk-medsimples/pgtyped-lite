import { parseSQLFile, TSQueryAST } from '@pgtyped-lite/parser';
import { IQueryTypes } from '@pgtyped-lite/query/lib/actions.js';
import { ParameterTransform } from '@pgtyped-lite/runtime';
...
describe('query-to-interface translation', () => {
  [ProcessingMode.SQL, ProcessingMode.TS].forEach((mode) => {
    ...
    `;
      ...
      const expectedTypes = `import { PreparedQuery } from '@pgtyped-lite/runtime';
